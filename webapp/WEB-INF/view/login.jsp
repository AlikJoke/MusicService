...
<body bgcolor="#c0c0d9">
	<div style="position:fixed;margin-left:36%;margin-top:15%;width:350px;height:200px;
		outline: 2px solid #000;border: 3px solid #fff;border-radius: 10px;background:#c0a0d9">
	    <form action="${pageContext.request.contextPath}/j_spring_security_check"  method="POST">
	        <table style="width:100px;height:100px;margin-left:5px;margin-top:20px;">
	        	<tr>
	        ...
	        <input style="margin-top:36px;height:40px;width:350px;" class="button10" type="submit" value="Войти"/>
	    </form>
    </div>
